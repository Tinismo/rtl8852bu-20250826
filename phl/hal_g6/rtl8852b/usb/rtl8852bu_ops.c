					...
					struct hal_info_t *hal)
{
	...
	ops->hal_fast_start = hal_fast_start_8852bu;
	ops->hal_fast_stop = hal_fast_stop_8852bu;
	...
	ops->enable_interrupt = hal_enable_int_8852bu;
	ops->disable_interrupt = hal_disable_int_8852bu;
	ops->config_interrupt = hal_config_int_8852bu;
	ops->recognize_halt_c2h_interrupt = hal_recognize_halt_c2h_int_8852bu;
	ops->clear_interrupt = hal_clear_interrupt_8852bu;
}
