...
/* LA-USB 8852C*/
static struct dle_size_t wde_size34 = {
	MAC_AX_WDE_PG_64, /* pge_size */
	384, /* lnk_pge_num */
	0, /* unlnk_pge_num */
};

/* 8852BT SCC/SCC TURBO */
static struct dle_size_t wde_size43 = {
	MAC_AX_WDE_PG_64, /* pge_size */
	768, /* lnk_pge_num */
	0, /* unlnk_pge_num */
};
...
/* 8852BT SDIO */
static struct dle_size_t wde_size44 = {
	MAC_AX_WDE_PG_64, /* pge_size */
	254, /* lnk_pge_num */
	2, /* unlnk_pge_num */
};
...
/* 8852BT USB3.0 */
static struct dle_size_t wde_size46 = {
	MAC_AX_WDE_PG_64, /* pge_size */
	504, /* lnk_pge_num */
	8, /* unlnk_pge_num */
};
...
/* 8852C LA */
static struct dle_size_t ple_size38 = {
	MAC_AX_PLE_PG_128, /* pge_size */
	1328, /* lnk_pge_num */
	16, /* unlnk_pge_num */
};
...
/* 8852BT USB SCC */
static struct dle_size_t ple_size51 = {
	MAC_AX_PLE_PG_128, /* pge_size */
	2416, /* lnk_pge_num */
	16, /* unlnk_pge_num */
};

/* 8852BT USB SCC TURBO */
static struct dle_size_t ple_size52 = {
	MAC_AX_PLE_PG_128, /* pge_size */
	3184, /* lnk_pge_num */
	16, /* unlnk_pge_num */
};
...
/* 8852BT SDIO SCC */
static struct dle_size_t ple_size53 = {
	MAC_AX_PLE_PG_128, /* pge_size */
	2672, /* lnk_pge_num */
	16, /* unlnk_pge_num */
};

/* 8852BT SDIO SCC TURBO */
static struct dle_size_t ple_size54 = {
	MAC_AX_PLE_PG_128, /* pge_size */
	3440, /* lnk_pge_num */
	16, /* unlnk_pge_num */
};
...
/* 8852C DBCC USB2.0 */
static struct dle_size_t ple_size55 = {
	MAC_AX_PLE_PG_128, /* pge_size */
	3341, /* lnk_pge_num */
	51, /* unlnk_pge_num */
};
...
/* 8852BT USB3 */
static struct dle_size_t ple_size57 = {
	MAC_AX_PLE_PG_256, /* pge_size */
	1656, /* lnk_pge_num */
	8, /* unlnk_pge_num */
};
...
/* 8852BT USB2.0 */
static struct dle_size_t ple_size58 = {
	MAC_AX_PLE_PG_256, /* pge_size */
	1656, /* lnk_pge_num */
	8, /* unlnk_pge_num */
};
...
/* LA USB 8852C */
static struct wde_quota_t wde_qt33 = {
	338, /* hif */
	6, /* wcpu */
	0, /* dcpu */
	0, /* pkt_in */
...
/* 8852BT SDIO */
static struct wde_quota_t wde_qt34 = {
	240, /* hif */
	8, /* wcpu */
	0, /* dcpu */
	0, /* pkt_in */
...
/* 8852BT SCC/SCC TRUBO */
static struct wde_quota_t wde_qt44 = {
	512, /* hif */
	196, /* wcpu */
	0, /* dcpu */
	0, /* pkt_in */
...
/*8852BT USB3.0 */
static struct wde_quota_t wde_qt47 = {
	404, /* hif */
	60, /* wcpu */
	0, /* dcpu */
	0, /* pkt_in */
...
/* USB SCC */
static struct ple_quota_t ple_qt119 = {
	1536, /* cmac0_tx */
	0, /* cmac1_tx */
	16, /* c2h */
	48, /* h2c */
...
/* USB SCC */
static struct ple_quota_t ple_qt120 = {
	1536, /* cmac0_tx */
	0, /* cmac1_tx */
	366, /* c2h */
	48, /* h2c */
...
/* USB SCC TURBO*/
static struct ple_quota_t ple_qt121 = {
	1536, /* cmac0_tx */
	0, /* cmac1_tx */
	16, /* c2h */
	48, /* h2c */
...
/* USB SCC TURBO*/
static struct ple_quota_t ple_qt122 = {
	1536, /* cmac0_tx */
	0, /* cmac1_tx */
	1134, /* c2h */
	48, /* h2c */
...
/* 8852BT SDIO SCC */
static struct ple_quota_t ple_qt123 = {
	1024, /* cmac0_tx */
	0, /* cmac1_tx */
	16, /* c2h */
	16, /* h2c */
...
/* 8852BT SDIO SCC */
static struct ple_quota_t ple_qt124 = {
	1024, /* cmac0_tx */
	0, /* cmac1_tx */
	1403, /* c2h */
	16, /* h2c */
...
/* 8852BT SDIO SCC TURBO */
static struct ple_quota_t ple_qt125 = {
	1536, /* cmac0_tx */
	0, /* cmac1_tx */
	16, /* c2h */
	16, /* h2c */
...
/* 8852BT SDIO SCC TURBO */
static struct ple_quota_t ple_qt126 = {
	1536, /* cmac0_tx */
	0, /* cmac1_tx */
	1659, /* c2h */
	16, /* h2c */
...
/*8852C USB DBCC USB2.0*/
static struct ple_quota_t ple_qt127 = {
	988, /* cmac0_tx */
	0, /* cmac1_tx */
	16, /* c2h */
	48, /* h2c */
...
/*8852C USB DBCC USB2.0*/
static struct ple_quota_t ple_qt128 = {
	988, /* cmac0_tx */
	0, /* cmac1_tx */
	32, /* c2h */
	48, /* h2c */
...
/* SDIO LOGO */
static struct ple_quota_t ple_qt129 = {
	1220, /* cmac0_tx */
	0, /* cmac1_tx */
	16, /* c2h */
	16, /* h2c */
...
/* SDIO LOGO */
static struct ple_quota_t ple_qt130 = {
	1220, /* cmac0_tx */
	0, /* cmac1_tx */
	41, /* c2h */
	16, /* h2c */
...
/*8852B USB3.0_192K_LOGO*/
static struct ple_quota_t ple_qt131 = {
	1232, /* cmac0_tx */
	0, /* cmac1_tx */
	16, /* c2h */
	32, /* h2c */
...
/*8852B USB3.0_192K_LOGO*/
static struct ple_quota_t ple_qt132 = {
	1232, /* cmac0_tx */
	0, /* cmac1_tx */
	32, /* c2h */
	48, /* h2c */
...
/* 8852A USB SCC USB3 */
static struct ple_quota_t ple_qt133 = {
	2654, /* cmac0_tx */
	0, /* cmac1_tx */
	16, /* c2h */
	48, /* h2c */
...
/* 8852BT USB3.0*/
static struct ple_quota_t ple_qt136 = {
	1470, /* cmac0_tx */
	0, /* cmac1_tx */
	8, /* c2h */
	24, /* h2c */
...
/* 8852BT USB3.0*/
static struct ple_quota_t ple_qt137 = {
	1473, /* cmac0_tx */
	0, /* cmac1_tx */
	16, /* c2h */
	24, /* h2c */
...
/* USB2.0 52BT */
static struct ple_quota_t ple_qt138 = {
	728, /* cmac0_tx */
	0, /* cmac1_tx */
	8, /* c2h */
	24, /* h2c */
...
/* USB2.0 52BT */
static struct ple_quota_t ple_qt139 = {
	728, /* cmac0_tx */
	0, /* cmac1_tx */
	16, /* c2h */
	24, /* h2c */
...
static struct dle_mem_t dle_mem_pcie_8852bt[] = {
	{MAC_AX_QTA_SCC, /* qta_mode */
	 &wde_size23, &ple_size9, /* wde_size, ple_size */
	 &wde_qt23, &wde_qt23, /* wde_min_qt, wde_max_qt */
	 &ple_qt57, &ple_qt59}, /* ple_min_qt, ple_max_qt */
	{MAC_AX_QTA_SCC_TURBO, /* qta_mode */
	 &wde_size23, &ple_size5, /* wde_size, ple_size */
	 &wde_qt23, &wde_qt23, /* wde_min_qt, wde_max_qt */
	 &ple_qt57, &ple_qt56}, /* ple_min_qt, ple_max_qt */
	{MAC_AX_QTA_SCC_STF, /* qta_mode */
	 &wde_size1, &ple_size2, /* wde_size, ple_size */
	 &wde_qt1, &wde_qt1, /* wde_min_qt, wde_max_qt */
	 &ple_qt8, &ple_qt9}, /* ple_min_qt, ple_max_qt */
...
static struct dle_mem_t dle_mem_usb2_8852a[] = {
	{MAC_AX_QTA_SCC, /* qta_mode */
...
static struct dle_mem_t dle_mem_usb3_8852a[] = {
	{MAC_AX_QTA_SCC, /* qta_mode */
	 &wde_size1, &ple_size1, /* wde_size, ple_size */
	 &wde_qt1, &wde_qt1, /* wde_min_qt, wde_max_qt */
	 &ple_qt133, &ple_qt133}, /* ple_min_qt, ple_max_qt */
	{MAC_AX_QTA_DBCC, /* qta_mode */
	 &wde_size1, &ple_size1, /* wde_size, ple_size */
	 &wde_qt1, &wde_qt1, /* wde_min_qt, wde_max_qt */
	 &ple_qt16, &ple_qt17}, /* ple_min_qt, ple_max_qt */
...
static struct dle_mem_t dle_mem_usb3_8852b[] = {
	...
	{MAC_AX_QTA_DLFW, /* qta_mode */
	 ...
	 &wde_size30, &ple_size31, /* wde_size, ple_size */
	 &wde_qt30, &wde_qt30, /* wde_min_qt, wde_max_qt */
	 &ple_qt131, &ple_qt132}, /* rsvd0_qt, rsvd1_qt */
	{MAC_AX_QTA_INVALID, NULL, NULL, NULL, NULL, NULL, NULL},
};
...
static struct dle_mem_t dle_mem_usb2_8852c[] = {
	...
	{MAC_AX_QTA_DBCC, /* qta_mode */
	 &wde_size27, &ple_size55, /* wde_size, ple_size */
	 &wde_qt27, &wde_qt27, /* wde_min_qt, wde_max_qt */
	 &ple_qt127, &ple_qt128}, /* ple_min_qt, ple_max_qt */
	{MAC_AX_QTA_DLFW, /* qta_mode */
	 &wde_size18, &ple_size18, /* wde_size, ple_size */
	 &wde_qt17, &wde_qt17, /* wde_min_qt, wde_max_qt */
	 &ple_qt44, &ple_qt45}, /* ple_min_qt, ple_max_qt */
	 {MAC_AX_QTA_LAMODE, /* qta_mode */
	 &wde_size34, &ple_size38, /* wde_size, ple_size */
	 &wde_qt33, &wde_qt33, /* wde_min_qt, wde_max_qt */
...
static struct dle_mem_t dle_mem_usb2_8852bt[] = {
	{MAC_AX_QTA_SCC, /* qta_mode */
	 &wde_size43, &ple_size51, /* wde_size, ple_size */
	 &wde_qt44, &wde_qt44, /* wde_min_qt, wde_max_qt */
	 &ple_qt119, &ple_qt120},/* ple_min_qt, ple_max_qt */
	{MAC_AX_QTA_SCC_TURBO, /* qta_mode */
	 &wde_size31, &ple_size58, /* wde_size, ple_size */
	 &wde_qt31, &wde_qt31, /* wde_min_qt, wde_max_qt */
	 &ple_qt138, &ple_qt139}, /* ple_min_qt, ple_max_qt */
	{MAC_AX_QTA_DLFW, /* qta_mode */
	 &wde_size18, &ple_size18, /* wde_size, ple_size */
	 &wde_qt17, &wde_qt17, /* wde_min_qt, wde_max_qt */
	 &ple_qt44, &ple_qt45}, /* ple_min_qt, ple_max_qt */
...
static struct dle_mem_t dle_mem_usb3_8852bt[] = {
	{MAC_AX_QTA_SCC, /* qta_mode */
	 &wde_size43, &ple_size51, /* wde_size, ple_size */
	 &wde_qt44, &wde_qt44, /* wde_min_qt, wde_max_qt */
	 &ple_qt119, &ple_qt120},/* ple_min_qt, ple_max_qt */
	{MAC_AX_QTA_SCC_TURBO, /* qta_mode */
	 &wde_size46, &ple_size57, /* wde_size, ple_size */
	 &wde_qt47, &wde_qt47, /* wde_min_qt, wde_max_qt */
	 &ple_qt136, &ple_qt137}, /* ple_min_qt, ple_max_qt */
	{MAC_AX_QTA_DLFW, /* qta_mode */
	 &wde_size18, &ple_size18, /* wde_size, ple_size */
	 &wde_qt17, &wde_qt17, /* wde_min_qt, wde_max_qt */
	 &ple_qt44, &ple_qt45}, /* ple_min_qt, ple_max_qt */
...
static struct dle_mem_t dle_mem_sdio_8852b[] = {
	{MAC_AX_QTA_DLFW, /* qta_mode */
	 ...
	 &wde_size13, &ple_size29, /* wde_size, ple_size */
	 &wde_qt12, &wde_qt12, /* wde_min_qt, wde_max_qt */
	 &ple_qt129, &ple_qt130}, /* ple_min_qt, ple_max_qt */
	 {MAC_AX_QTA_LAMODE, /* qta_mode */
...
static struct dle_mem_t dle_mem_sdio_8852bt[] = {
	{MAC_AX_QTA_SCC, /* qta_mode */
	 &wde_size44, &ple_size53, /* wde_size, ple_size */
	 &wde_qt34, &wde_qt34, /* wde_min_qt, wde_max_qt */
	 &ple_qt123, &ple_qt124}, /* ple_min_qt, ple_max_qt */
	{MAC_AX_QTA_SCC_TURBO, /* qta_mode */
	 &wde_size44, &ple_size54, /* wde_size, ple_size */
	 &wde_qt34, &wde_qt34, /* wde_min_qt, wde_max_qt */
	 &ple_qt125, &ple_qt126}, /* ple_min_qt, ple_max_qt */
	{MAC_AX_QTA_DLFW, /* qta_mode */
	 &wde_size4, &ple_size4, /* wde_size, ple_size */
	 &wde_qt4, &wde_qt4, /* wde_min_qt, wde_max_qt */
	 &ple_qt13, &ple_qt13}, /* ple_min_qt, ple_max_qt */
...
static u32 dle_rsvd_size(struct mac_ax_adapter *adapter, enum mac_ax_qta_mode mode)
{
	if (mode == MAC_AX_QTA_LAMODE) {
		...
		if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852B))
			...
			return DLE_SCC_RSVD_SIZE_8852BT;
		else
			return 0;
	} else {
		return 0;
					 ...
					 enum mac_ax_qta_mode mode)
{
	...
	case MAC_AX_INTF_USB:
		...
		if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) &&
			...
			cfg = dle_mem_usb2_8852a;
		else if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) &&
			 (get_usb_mode(adapter) == MAC_AX_USB3))
			cfg = dle_mem_usb3_8852a;
		else
#endif
		...
		if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852BT) &&
			 (get_usb_mode(adapter) == MAC_AX_USB2))
			cfg = dle_mem_usb2_8852bt;
		else if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852BT))
			cfg = dle_mem_usb3_8852bt;
		else
#endif
			cfg = NULL;
		break;
	       ...
	       u8 *is_poh)
{
	*is_poh = (mode == MAC_AX_QTA_SCC_STF || mode == MAC_AX_QTA_DBCC_STF ||
		   adapter->env_info.intf != MAC_AX_INTF_PCIE) ? 0 : 1;
...
static u32 h2c_dle_qta_change(struct mac_ax_adapter *adapter)
{
	...
	h2c_info.h2c_func = FWCMD_H2C_FUNC_DLE_QTA_CHANGE;
	h2c_info.rec_ack = 0;
	h2c_info.done_ack = 0;
		      ...
		      u32 qtaid, u32 *used_size, u32 *aval_size)
{
	...
	case DLE_CTRL_TYPE_WDE:
		if (qtaid >= WDE_QTAID_LAST) {
			*used_size = 0;
			*aval_size = 0;
			return MACHWNOSUP;
		}
		quota.dle_type = ctrl_tp;
		quota.qtaid = qtaid;
		pg_size = adapter->dle_info.wde_pg_size;
		break;
	case DLE_CTRL_TYPE_PLE:
		if (qtaid >= PLE_QTAID_LAST) {
			*used_size = 0;
			*aval_size = 0;
			return MACHWNOSUP;
		}
		quota.dle_type = ctrl_tp;
		quota.qtaid = qtaid;
		pg_size = adapter->dle_info.ple_pg_size;
		break;
	default:
		PLTFM_MSG_ERR("%s dle ctrl type %d invalid\n", __func__, ctrl_tp);
		return MACFUNCINPUT;
	}

	ret = dle_dfi_quota(adapter, &quota);
	if (ret != MACSUCCESS) {
		PLTFM_MSG_ERR("%s dle_dfi_quota fail %d\n", __func__, ret);
		return ret;
	}

	*used_size = quota.use_pgnum * pg_size;
	*aval_size = quota.rsv_pgnum * pg_size;
