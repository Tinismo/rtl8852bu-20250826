...
struct mac_ax_priv_ops {
	...
	u32 (*dle_dfi_sel)(struct mac_ax_adapter *adapter,
			   ...
			   u32 *target, u32 sel);
	u32 (*dbg_port_cmac)(struct mac_ax_adapter *adapter, u32 isr_mod, u8 band);
	u32 (*dbg_port_dmac)(struct mac_ax_adapter *adapter, u32 isr_mod);
	...
	void (*record_h2c_path)(struct mac_ax_adapter *adapter, enum mac_h2cc2h_path_dbg id);
	void (*get_h2c_path)(struct mac_ax_adapter *adapter, enum mac_h2cc2h_path_dbg id);
	...
	u32 (*write_pcie_cfg_spc)(struct mac_ax_adapter *adapter, u16 addr, u32 *val);
	u32 (*pcie_aspm_frontdoor_set)(struct mac_ax_adapter *adapter);
#if MAC_AX_FEATURE_DBGPKG
	u32 (*pcie_mon)(struct mac_ax_adapter *adapter,
			char *output, u32 out_len, u32 *used);
#endif
	...
	u32 (*pcie_set_oobs)(struct mac_ax_adapter *adapter, struct mac_ax_intf_info *intf_info);
	u32 (*dump_pcie_ser_info)(struct mac_ax_adapter *adapter);
#endif
#if MAC_AX_SDIO_SUPPORT
	...
	u32 (*usb_stuck_detect)(struct mac_ax_adapter *adapter);
