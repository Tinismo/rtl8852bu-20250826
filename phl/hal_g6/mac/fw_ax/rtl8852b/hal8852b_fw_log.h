...
enum LOG_MSG_8852B_TABLE {
    ...
    MSG_8852B_AXIDMA_05,                                                  //"No tx_para_p input\n"
    MSG_8852B_AXIDMA_06,                                                  //"AXIDMA TX setup buff fail %d\n"
    MSG_8852B_AXIDMA_07,                                                  //"AXIDMA TX CH1 no ppld_info input\n"
    ...
    MSG_8852B_WOWLAN_9,							 //"\nAppendTkipMICComm\n"
    MSG_8852B_WOWLAN_10,						 //"key[%d]=%x\n"
    MSG_8852B_WOWLAN_11,						 //"DA[%d]=%x\n"
    MSG_8852B_WOWLAN_12,						 //"SA[%d]=%x\n"
    MSG_8852B_WOWLAN_13,						 //"Priority[%d]=%x\n"
    MSG_8852B_WOWLAN_14,						 //"data[%d]=%x\n"
    MSG_8852B_WOWLAN_15,						 //"miccode[%d]=%x\n"
    ...
    MSG_8852B_MP_1,                                                       //"ips 0x1C err = 0x%x\n"
    ...
    MSG_8852B_TASK_ERROR,                                                 //"Task Error: %x\n"
    ...
    MSG_8852B_PKTOFLD_NULL,                                         //"pktofld mal null and return\n"
    MSG_8852B_PKTOFLD_NULL_RSP,                                         //"pktofld rsp mal null and return\n"
    MSG_8852B_PKTOFLD_SEMO_FAIL, //"pktofld semaphore fail\n"
    ...
    MSG_8852B_PROXY_CFG_VAL_ERR,                                            //"[Proxy] Cfg fail (value err), (ln %d)\n"
    MSG_8852B_PROXY_PATTERN_SW_WAKE,                                        //"[Proxy][Pattern] SW pattern match wake. Rsn (%x) Isv6 (%d)\n"
    MSG_8852B_MCC_CHANGEROLE_9,                                             //"[MCC][Warning] TSF abnormal, cur_tsf = 0x%x, tsf = 0x%x\n"
    MSG_8852B_PS_TRX_TIMEOUT,                                               //"=>TRXTimeOut\n"
    ...
    MSG_8852B_CSI_H2C_PEER_MACID_DUMP,                                      //"[CSI] H2C. peer macid index(%d), packet id(%d)\n"
    ...
    MSG_8852B_NAN_DW_START_2G_TSF,                                          //"[NAN] DW Start 2G Port = 0x%x, free run = 0x%x , tsf = 0x%x\n"
    MSG_8852B_NAN_DW_START_5G_TSF,                                          //"[NAN] DW Start 5G Port = 0x%x, free run = 0x%x , tsf = 0x%x\n"
    MSG_8852B_NAN_DW_END_TSF,                                               //"[NAN] DW Start END Port = 0x%x, free run = 0x%x , tsf = 0x%x\n"
    MSG_8852B_NAN_DISC_BEACON_START_2G_TSF,                                 //"[NAN] Disc Bcn Start 2G Port = 0x%x, free run = 0x%x , tsf = 0x%x\n"
    MSG_8852B_NAN_DISC_BEACON_START_5G_TSF,                                 //"[NAN] Disc Bcn Start 5G Port = 0x%x, free run = 0x%x , tsf = 0x%x\n"
    MSG_8852B_NAN_SDF_START,                                                //"[NAN] SDF Start tsf=%x\n"
    MSG_8852B_NAN_BCN_TX_SUCCESS,                                           //"[NAN] BCN TX SUCCESS \n"
    MSG_8852B_NAN_BCN_TX_FAIL,                                              //"[NAN] BCN TX fail reason:%d \n"
    MSG_8852B_NAN_BCN_TX_TIME,                                              //"[NAN] BCN TX time: hi = 0x%x low = 0x%x \n"
    MSG_8852B_NAN_BCN_TX_END,                                               //"[NAN] BCN TX success at tsf = 0x%x\n"
    MSG_8852B_NAN_BCN_TX_EN,                                                //"[NAN] BCN TX port = 0x%x\n"
    MSG_8852B_NAN_FUNC_FAIL,                                                //"[NAN] FAIL in func: %d, line: %d, ret = %d\n"
    MSG_8852B_NAN_SYNC_BCN_RX,                                              //"[NAN] RX NAN SYNC BCN , SN = %d\n"
    MSG_8852B_NAN_SYNC_BCN_RX_TOTAL,                                        //"[NAN] RX NAN SYNC BCN Total in a DW , cnt = %d\n"
    MSG_8852B_NAN_DISC_BCN_RX,                                              //"[NAN] RX NAN DISC BCN , SN = %d\n"
    MSG_8852B_NAN_BCN_RX_BYPASS,                                            //"[NAN] RX NON-NAN BCN \n"
    MSG_8852B_NAN_DISC_BCN_RX_BYPASS,                                       //"[NAN] RX DISC BCN BYPASS \n"
    MSG_8852B_NAN_MPORT_SETTING_IN_FW,                                      //"[NAN] Setting Mport in FW\n"
    MSG_8852B_NAN_FAW_START,                                                //"[NAN] FAW module %d start, freerun = 0x%x ,tsf = 0x%x\n"
    MSG_8852B_NAN_FAW_END,                                                  //"[NAN] FAW module %d end, tsf = 0x%x\n"
    MSG_8852B_NAN_FAW_DELETE,                                               //"[NAN] FAW module %d delete\n"
    MSG_8852B_NAN_WARMUP_END,                                               //"[NAN] warmup end\n"
    MSG_8852B_NAN_CLIENT_START,                                             //"[NAN] Client start, free run = 0x%x, tsf = 0x%x\n"
    MSG_8852B_NAN_CLIENT_END,                                               //"[NAN] Client end, free run = 0x%x, tsf = 0x%x\n"
    MSG_8852B_NAN_TX_NULL_EARLY,                                            //"[NAN] TX Null early, mac_id = %d, free run = 0x%x, tsf = 0x%x\n"
    MSG_8852B_NAN_DW_START_OVER_TIME,                                       //"[NAN] DW Start task run over time, duration = 0x%x\n"
    MSG_8852B_NAN_DW_END_OVER_TIME,                                         //"[NAN] DW End task run over time, duration = 0x%x\n"
    MSG_8852B_NAN_DISC_START_OVER_TIME,                                     //"[NAN] DISC Start task run over time, duration = 0x%x\n"
    MSG_8852B_NAN_CLIENT_START_OVER_TIME,                                   //"[NAN] Client Start task run over time, duration = 0x%x\n"
    MSG_8852B_NAN_P2P_START,                                                //"[NAN] P2P start, free run = 0x%x, tsf = 0x%x\n"
    MSG_8852B_NAN_P2P_END,                                                  //"[NAN] P2P end, free run = 0x%x, tsf = 0x%x\n"
    MSG_8852B_NAN_P2P_START_OVER_TIME,                                      //"[NAN] P2P Start task run over time, duration = 0x%x\n"
    MSG_8852B_NAN_FAW_START_OVER_TIME,                                      //"[NAN] FAW Start task run over time, duration = 0x%x\n"
    MSG_8852B_NAN_DISC_BEACON_END,                                          //"[NAN] Disc Bcn END Port = 0x%x, free run = 0x%x , tsf = 0x%x\n"
    MSG_8852B_MALLOC_17,                                                    //"%d\t%d\t\t%d\n"
    MSG_8852B_CONSOLE_15,                                                   //"Index\tAddress\t\tMSID\t\tFunc\tType\tSize(B)\n"
    MSG_8852B_CONSOLE_16,                                                   //"----------------------------------------------------------------\n"
    MSG_8852B_CONSOLE_17,                                                   //"MSID\t\tGroup(Func)\t\tCounter\tTotalSize(B)\tHistorical High\n"
    MSG_8852B_CONSOLE_18,                                                   //"--------------------------------------------------------------------------------\n"
    MSG_8852B_CONSOLE_19,                                                   //"MSID\t\tCounter\tTotalSize(B)\n"
    MSG_8852B_CONSOLE_20,                                                   //"----------------------------------------\n"
    MSG_8852B_SCAN_NOT_SUPPORT,                                             //"[Scan] Fw not support scanofld\n"
    MSG_8852B_SCAN_HSTCTRL_FAIL_BAND_ERR,                                   //"[Scan][Hst] Fail since band %d >= %d\n"
    MSG_8852B_SCAN_HSTCTRL_FAIL_NOT_SCANNING,                               //"[Scan][Hst] Fail since band %d not scanning\n"
    ...
    MSG_8852B_SCAN_ADD_FAIL_BAND_ERR,                                       //"[Scan][Add] Fail since band %d >= %d\n"
    MSG_8852B_SCAN_ADD_FAIL_SCANNING,                                       //"[Scan][Add] Fail since band %d is scanning\n"
    ...
    MSG_8852B_SCAN_FAIL_BAND_ERR,                                           //"[Scan][Cfg] Fail since band 1 not enabled\n"
    ...
    MSG_8852B_DEF_01,                                                       //"[DEF] ebw = 0x%x\n"
    MSG_8852B_DEF_02,                                                       //"[DEF] dbw = 0x%x, mbw = 0x%x, eflag = 0x%x\n"
    MSG_8852B_DEF_03,                                                       //"[DEF] eptcl = 0x%x, cptcl = 0x%x\n"
    MSG_8852B_DEF_04,                                                       //"[DEF] band no chk, rfband = 0x%x\n"
    MSG_8852B_STACSA_CH_NOT_FOUND,                                          //"[CSA] ch %d not found\n"
    MSG_8852B_STACSA_CH_SUPP_BW,                                            //"[CSA] ch %d supported bw %x\n"
    MSG_8852B_STACSA_CSATIMEOUT,                                            //"[CSA] pri(%x), cent(%d), bw(%d), ch_band(%d)\n"
    MSG_8852B_STACSA_CHNLSA,                                                //"[CSA] CHNLSA ch %d cnt %d\n"
    MSG_8852B_STACSA_2NDCHOFST,                                             //"[CSA] SecondChnlOffset offset %d\n"
    MSG_8852B_STACSA_WIDEBWCHSW,                                            //"[CSA] WideBwChnlSw width %d seg0 %d seg1 %d\n"
    MSG_8852B_STACSA_WIDEBWCHSW_WRP,                                        //"[CSA] WideBwChnlSw(Wrp) width %d seg0 %d seg1 %d\n"
    MSG_8852B_STACSA_HTCAP_20_40,                                           //"[CSA] HT cap 20/40\n"
    MSG_8852B_STACSA_HTCAP_SET_40,                                          //"[CSA] HT cap set bcn_ch_width to 40\n"
    MSG_8852B_STACSA_HTINFO_ANYBW,                                          //"[CSA] HT info allow any chwidth\n"
    MSG_8852B_STACSA_HTINFO_SET_40,                                         //"[CSA] HT info set bcn_ch_width to 40\n"
    MSG_8852B_STACSA_HTINFO_SET_UP,                                         //"[CSA] HT info set bcn_ch_offset to upper\n"
    MSG_8852B_STACSA_HTINFO_SET_LW,                                         //"[CSA] HT info set bcn_ch_offset to lower\n"
    MSG_8852B_STACSA_HTINFO_SET_20,                                         //"[CSA] HT info set bcn_ch_offset and width to dont care 20\n"
    MSG_8852B_STACSA_VHTOP_BW,                                              //"[CSA] VHTOP set bcn_ch_width to %d\n"
    MSG_8852B_STACSA_CSAIE,                                                 //"[CSA] CSA IE: ch(%d) csa_ch_width(%d) ofst(%d)\n"
    MSG_8852B_STACSA_CSA_80,                                                //"[CSA] CSA IE: bw 80\n"
    MSG_8852B_STACSA_CSA_20,                                                //"[CSA] CSA IE: bw 20\n"
    MSG_8852B_STACSA_CSA_40_UP,                                             //"[CSA] CSA IE: bw 40 upper\n"
    MSG_8852B_STACSA_CSA_40_LW,                                             //"[CSA] CSA IE: bw 40 lower\n"
    MSG_8852B_STACSA_CSA_CH_BAND,                                           //"[CSA] CSA IE: ch_band %d\n"
    MSG_8852B_STACSA_CSA_CENT_CH,                                           //"[CSA] CSA IE: central_ch %d\n"
    MSG_8852B_STACSA_CSA_FINAL,                                             //"[CSA] CSA IE: going to switch to p(%d) c(%d) bw(%d) band(%d)\n"
    MSG_8852B_STACSA_BCN,                                                   //"[CSA] BCN IE: ori bw (%d) ofst (%d), new bw (%d) ofst (%d)\n"
    MSG_8852B_STACSA_BCN_SWITCH,                                            //"[CSA] BCN IE: switch to p(%d) c(%d) bw(%d) band(%d)\n"
    MSG_8852B_STACSA_BROKEN_BCN,                                            //"[CSA] Broken bcn\n"
    MSG_8852B_STACSA_CFG_CHLIST_ERR,                                        //"[CSA] size(hst, fw) = (%d, %d), chNum(%d)\n"
    MSG_8852B_WOWLAN_MAGIC_WAKER_0,                                         //"[MagicWaker] waker num = 0\n"
    MSG_8852B_WOWLAN_MAGIC_WAKER_1,                                         //"[MagicWaker] waker num = %d\n"
    MSG_8852B_WOWLAN_MAGIC_WAKER_ADDR_NULL,                                 //"[MagicWaker] pMagicWakerParm->MACAddr == NULL\n"
    MSG_8852B_WOWLAN_MAGIC_WAKER_INIT_ERR,                                  //"[MagicWaker] pMagicWakerParm == NULL\n"
    MSG_8852B_WOWLAN_TCP_KEEPALIVE_ERR,                                     //"[TCPKeepalive] pTCPKeepaliveParm == NULL\n"
    MSG_8852B_WOWLAN_TCP_KEEPALIVE_READ_ERR,                                //"[TCPKeepalive] ReadFWOfldPKT fail\n"
    MSG_8852B_WOWLAN_TCP_KEEPALIVE_IMMED_ERR,                               //"[TCPKeepalive] immediately tx fail\n"
    MSG_8852B_WOWLAN_TCP_KEEPALIVE_NO_ROLE,                                 //"[TCPKeepalive] role is not action\n"
    MSG_8852B_WOWLAN_TCP_KEEPALIVE_ENQ_ERR,                                 //"[TCPKeepalive] WowCpuMgPktEnQueue fail\n"
    MSG_8852B_WOWLAN_TCP_KEEPALIVE_DISABLE,                                 //"[TCPKeepalive] TCP Keepalive is disabled\n"
    MSG_8852B_WOWLAN_TCP_KEEPALIVE_TIMER_0,                                 //"[TCPKeepalive] create timer fail\n"
    MSG_8852B_WOWLAN_TCP_KEEPALIVE_TIMER_1,                                 //"[TCPKeepalive] start timer fail\n"
    MSG_8852B_WOWLAN_TCP_KEEPALIVE_TIMER_2,                                 //"[TCPKeepalive] timer = NULL\n"
    MSG_8852B_WOWLAN_TCP_KEEPALIVE_IMM_FAIL,                                //"[TCPKeepalive] TCP Keepalive immediately tx fail\n"
    MSG_8852B_SPIC_1,                                                       //"dum_first(%d), dum_last(%d)\n"
    MSG_8852B_SPIC_2,                                                       //"Update RDTIME[%d]BAUD[%d]IO[%d]CMD[%x]DUM[%d]\n"
    MSG_8852B_SPIC_3,                                                       //"\nFIANL BAUD[%x]IO[%x]CMD[%x]DUM[%x]\n"
    MSG_8852B_SPIC_4,                                                       //"FINAL[%x][%x]\n"
    MSG_8852B_SPIC_5,                                                       //"T1[%x]T2[%x]RDTIME[%x]\n"
    MSG_8852B_SPIC_6,                                                       //"BAUD[%x]CH[%x]CMD[%x]CYC[%x]\n"
    MSG_8852B_SPIC_7,                                                       //"SPIC Calibration Fail\n"
    MSG_8852B_SCAN_FAIL_NUMSHORTSSID_ERR,                                   //"[Scan][Cfg] Too much shortSsid (%d), abort\n"
    MSG_8852B_SCAN_FAIL_NUMBSSID_ERR,                                       //"[Scan][Cfg] Too much bssid (%d), abort\n"
    MSG_8852B_GTK_1,                                                 	    //"GTK Rekey Sha256 Fail(%d)\n"
    MSG_8852B_PS_RPWM_IMR_DUMP,                                             //"RPWM IMR is not enabled. IMR(0x%x) = 0x%x\n"
    MSG_8852B_WOWLAN_21,                                                    //"H2C AOAC Report Req fail\n"
    MSG_8852B_WOWLAN_22,                                                    //"WowCPUIoRxCtrl,en(%d)pull(%d)sus(%d)res(%d)idle(%d)\n"
    MSG_8852B_WOWLAN_23,                                                    //"WowCPUIoRxCtrl resume polling fw rx idle timeout\n"
    MSG_8852B_H2C2HREG_2,                                                   //"WowCPUIoRxCtrl fail\n"
    MSG_8852B_H2C2HREG_3,                                                   //"WowCPUIoRxCtrl success\n"
    MSG_8852B_MCC_SENDNULLCB_4,                                             //"[MCC][RPT] Retry DROP => macid (%d)\n"
    MSG_8852B_PS_POWER_LEVEL_1,                                             //"[Req_Pwr_Lvl] bcn_to_val = %d, ps_lvl = %d, trx_lvl = %d\n"
    MSG_8852B_PS_POWER_LEVEL_2,                                             //"[Req_Pwr_Lvl] BcnTimeOutTime = %d, BcnTimeOutLimit = %d, BcnTOTxNullLimit = %d, TRXTimeOutTime = %d\n"
    MSG_8852B_PS_POWER_LEVEL_ROLE_NOT_FOUND,                                //"[Req_Pwr_Lvl] Role not exist!. macid(%d)\n"
    ...
    MSG_8852B_MACIDPAUSE_AP_0,                                             //"[MACIDPAUSE] rcode: %d, pause_en: %x%x%x%x, pause_en_mask: %x%x%x%x\n"
    MSG_8852B_MACIDPAUSE_AP_1,                                             //"[MACIDPAUSE] original MACIDPauseFWInfo: %x%x%x%x\n"
    MSG_8852B_MACIDPAUSE_AP_2,                                             //"[MACIDPAUSE] MACIDPauseFWInfo: %x%x%x%x, MACIDPauseDRVInfo: %x%x%x%x, MACIDSleepFWInfo: %x%x%x%x\n"
    MSG_8852B_MACIDPAUSE_NIC,                                              //"[MACIDPAUSE] rcode: %d, pause_en: %x, pause_en_mask: %x, MACIDPauseFWInfo: %x -> %x, MACIDPauseDRVInfo: %x, MACIDSleepFWInfo: %x\n"
    ...
    MSG_8852B_WDT_DETECT_START_OK,					  		  //"start_ok\n"
    MSG_8852B_BACKTRACE_19,	        				          //"possible RA = 0x%x\n"
