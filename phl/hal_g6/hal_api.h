...
enum rtw_hal_status rtw_hal_port_deinit(void *hal, struct rtw_wifi_role_link_t *rlink, bool ext_port);
...
void rtw_hal_auto_debug_en_phy_util(void *hal, bool en);
...
u32 rtw_hal_handle_usb_interrupt_buffer(void *h, u8 *buf, u32 buf_len);
...
enum rtw_hal_status rtw_hal_set_rxfltr_by_scan(void *hinfo,
