...
enum rtw_hal_status
rtw_hal_mac_set_usr_tx_rpt_cfg(void *hal, struct rtw_phl_usr_tx_rpt_cfg *param);

enum rtw_hal_status
rtw_hal_mac_set_ch_busy_stat_cfg(struct hal_info_t *hal_info,
                                 struct mac_ax_ch_busy_cnt_cfg *mac_param);
