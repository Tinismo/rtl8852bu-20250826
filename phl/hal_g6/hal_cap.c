					 	...
					 	void *hal)
{
	...
	bus_cap->rx_int_buf_size = bus_hw->rx_int_buf_size;
	bus_cap->rx_int_buf_num = bus_sw->rx_int_buf_num ?
		bus_sw->rx_int_buf_num : bus_hw->rx_int_buf_num;
...
void rtw_hal_final_cap_decision(struct rtw_phl_com_t *phl_com, void *hal)
{
	...
	dev_cap->nan_sup = dev_sw_cap->nan_sup &
			   dev_hw_cap->wcpu_cap.mac_ofld_cap.nan;
#endif
